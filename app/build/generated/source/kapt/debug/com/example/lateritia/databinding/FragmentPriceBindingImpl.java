...
public class FragmentPriceBindingImpl extends FragmentPriceBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.enter_price_text, 1);
        sViewsWithIds.put(R.id.enter_price_input_layout, 2);
        sViewsWithIds.put(R.id.enter_price_input_text, 3);
        sViewsWithIds.put(R.id.ppl_submit_button, 4);
    }
    // views
    @NonNull
    ...
    public FragmentPriceBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private FragmentPriceBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
